...
const B24_DOMAIN = process.env.B24_DOMAIN || 'azaleia-peru.bitrix24.es';
const CLIENT_ID = process.env.B24_CLIENT_ID;
const CLIENT_SECRET = process.env.B24_CLIENT_SECRET;
const APP_PUBLIC_BASE = process.env.APP_PUBLIC_BASE; // https://squirrel-talented-hermit.ngrok-free.app

function getRedirectUri() {
  // DEBE coincidir con lo configurado en Bitrix: /b24/install
